...
guido.make_deposit(100).make_deposit(200).make_deposit(25).make_withdrawl(350).display_user_balance()  
...
monty.make_deposit(150).make_deposit(375).make_withdrawl(400).display_user_balance()
# monty.make_deposit(375)
# monty.make_withdrawl(400)
# monty.display_user_balance()

johni.make_deposit(825).make_withdrawl(175).make_withdrawl(300).make_withdrawl(65).display_user_balance()
